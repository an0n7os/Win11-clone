                ...
                <tbody>
                  {files.map((file, index) => (
                    <tr
                      ...
                      onClick={() => {
                        window.open(
                          `https://firebasestorage.googleapis.com/v0/b/anonyos.appspot.com/o/resume.pdf?alt=media&token=7968862d-f4c8-49f6-9358-9d09b1e647c1${file.name}`,
                          "_blank",
                          WIN_FEATURES
                        );
                      }}

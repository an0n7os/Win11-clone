...
const initialState = {
  ...
  pinnedApps: [
    ...
    },
    {
      ...
      onClick: () => {
        const textMessage = encodeURIComponent(
          "Hello Aswin Krishna!, [your message here]"
        );
        window.open(
          `https://wa.me/+919846356057?text=${textMessage}`,
          "_blank",
          WIN_FEATURES
        );
      },
    },
    {
      ...
      onClick: () => {
        window.open(
          "https://www.google.com/search?q=Aswin+krishna+vb&oq=asw&aqs=chrome.1.69i60j69i59l3j69i57j69i60l3.2467j0j1&sourceid=chrome&ie=UTF-8",
          "_blank",
          WIN_FEATURES
        );
      },
  ...
  shortcutApps: [
    ...
    },
    {
      ...
      onClick: () => {
        window.open(
          "https://www.linkedin.com/in/aswin-krishna-vb-4a69621ab/",
          "_blank",
          WIN_FEATURES
        );
      },
    ...
    },
    {
      ...
      width: 35,
      height: 35,
      onClick: () => (window.location.href = "mailto:aswinasher@gmail.com"),
    },
    // {
    //   name: "Search",
